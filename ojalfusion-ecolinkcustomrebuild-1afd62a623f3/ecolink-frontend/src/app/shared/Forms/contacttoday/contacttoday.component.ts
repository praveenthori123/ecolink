...
@Component({
  selector: 'app-contacttoday',
  templateUrl: './contacttoday.component.html',
  styleUrls: ['./contacttoday.component.scss']
})
export class ContacttodayComponent implements OnInit {
