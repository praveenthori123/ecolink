...
--
-- Host: localhost:3306
-- Generation Time: Jun 09, 2022 at 05:34 AM
...
CREATE TABLE `blogs` (
  ...
  `image` varchar(961) DEFAULT NULL,
  `alt` varchar(110) DEFAULT NULL,
  `category` varchar(79) DEFAULT NULL,
  `publish_date` datetime DEFAULT NULL,
  `status` varchar(7) NOT NULL,
  `short_desc` varchar(288) DEFAULT NULL,
  `description` mediumtext,
  `head_schema` varchar(200) DEFAULT NULL,
  `body_schema` varchar(200) DEFAULT NULL,
  `meta_title` varchar(200) DEFAULT NULL,
  `keywords` varchar(200) DEFAULT NULL,
  `meta_description` text,
  `og_title` varchar(200) DEFAULT NULL,
  `og_image` varchar(961) DEFAULT NULL,
...
CREATE TABLE `categories` (
  ...
  `head_schema` text COLLATE utf8mb4_unicode_ci,
  `body_schema` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `contact_questions` (
  ...
  `input_1` text COLLATE utf8mb4_unicode_ci,
  `input_2` text COLLATE utf8mb4_unicode_ci,
  `input_3` text COLLATE utf8mb4_unicode_ci,
  `input_4` text COLLATE utf8mb4_unicode_ci,
  `input_5` text COLLATE utf8mb4_unicode_ci,
  `input_6` text COLLATE utf8mb4_unicode_ci,
  `input_7` text COLLATE utf8mb4_unicode_ci,
  `input_8` text COLLATE utf8mb4_unicode_ci,
  `input_9` text COLLATE utf8mb4_unicode_ci,
  `input_10` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `coupons` (
  ...
  `product_id` bigint(20) UNSIGNED DEFAULT NULL,
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `min_order_amount` double(8,2) DEFAULT NULL,
  `max_order_amount` double(8,2) DEFAULT NULL,
  ...
  `times_applied` int(11) DEFAULT NULL,
...
--
-- Table structure for table `coupon_usedby`
--

CREATE TABLE `coupon_usedby` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `coupon_id` bigint(20) UNSIGNED DEFAULT NULL,
  `order_id` bigint(20) UNSIGNED DEFAULT NULL,
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `amount` double(8,2) DEFAULT NULL,
  `applied_times` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `links_on_pages`
--

CREATE TABLE `links_on_pages` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `discount_applied` double(8,2) DEFAULT NULL,
  `service_charge_applied` double(8,2) DEFAULT NULL,
  ...
  `shippment_via` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shippment_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `low_stock` int(10) UNSIGNED DEFAULT NULL,
  `sold_individually` int(10) UNSIGNED DEFAULT NULL,
  `minimum_qty` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Indexes for table `coupon_usedby`
--
ALTER TABLE `coupon_usedby`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `links_on_pages`
--
ALTER TABLE `links_on_pages`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `coupon_usedby`
--
ALTER TABLE `coupon_usedby`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `links_on_pages`
--
ALTER TABLE `links_on_pages`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
